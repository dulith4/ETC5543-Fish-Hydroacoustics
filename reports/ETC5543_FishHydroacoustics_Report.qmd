...
As foreshadowed in Section 4.4, the EDA suggested strongest separation in the 50–90 and 140–160 kHz bands. The permutation importance below quantifies this from a trained classifier’s perspective: shuffling each frequency in turn and measuring the AUC drop. The largest drops occur in the same bands, indicating that the model’s predictive power is indeed concentrated where the Cohen’s d analysis pointed.”
